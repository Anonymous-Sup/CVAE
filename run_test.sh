...
# --train_format base \
# --train_stage klstage \
# --resume /home/zhengwei/Desktop/Zhengwei/Projects/CVAE/outputs/market1k/clipreid_simplevae_tune/novel/2024-06-19/TunedF_SimpleVAE_128+64z_1e3+3_60+120_KLtotalZ_cls+CE+Text512 \
# --gpu 0 \
# --vae_type SinpleVAE \
# --recon_loss mse \
...
# --eval \
# --use_NCE \
# --saved_name TunedF_SimpleVAE_128+64z_1e3+3_60+120_KLtotalZ_cls+CE+Text512 \
# > test_test_test_1.log 2>&1 & 
...
# --train_format base \
# --train_stage klstage \
# --resume /home/zhengwei/Desktop/Zhengwei/Projects/CVAE/outputs/market1k/clipreid_simplevae_ablations/novel/2024-07-03/ablation_SimpleVAE+2E_128+64z_1e3+3_60+120_KLtotalZ_cls_OnlyRGB \
# --gpu 0 \
# --vae_type SinpleVAE \
# --recon_loss mse \
# --reid_loss crossentropy \
...
# --eval \
# --use_two_encoder \
# --saved_name ablation_SimpleVAE+2E_128+64z_1e3+3_60+120_KLtotalZ_cls_OnlyRGB \
# > test_rgb_plots_2E.log 2>&1 & 
