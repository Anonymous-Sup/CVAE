...
--resume  /data/zhengwei/CVAE/outputs/market1k/clipreid_tuned_person/novel/2024-09-05/novelMask1K_SimpleVAE_128+64z_1e3_60+120_KLtotalZ_noCLS \
--gpu 1 \
--saved_name novelMask1K_SimpleVAE_128+64z_1e3_60+120_KLtotalZ_L1280+bnTuneVersion+distCLS_Trip+Center+Ce \
--vae_type SinpleVAE \
--recon_loss mse \
--reid_loss crossentropy \
--gaussian MultivariateNormal \
> nohup_logs/tune_2nd_novelMask1K_SimpleVAE_128+64z_1e3_60+120_KLtotalZ_L1280+bnTuneVersion+distCLS_Trip+Center+Ce.log 2>&1 &
...
--train_format novel \
--train_stage reid+cls_stage \
--resume  /data/zhengwei/CVAE/outputs/market1k/clipreid_tuned_person/novel/2024-09-05/novelMask1K_SimpleVAE+2E_128+64z_1e3_60+120_KLtotalZ_noCLS \
--gpu 1 \
--saved_name novelMask1K_SimpleVAE+2E_128+64z_1e3_60+120_KLtotalZ_L1280+bnTuneVersion+distCLS_Trip+Center+Ce \
--vae_type SinpleVAE \
--recon_loss mse \
--use_two_encoder \
--reid_loss crossentropy \
--gaussian MultivariateNormal \
> nohup_logs/tune_2nd_novelMask1K_SimpleVAE+2E_128+64z_1e3_60+120_KLtotalZ_L1280+bnTuneVersion+distCLS_Trip+Center+Ce.log 2>&1 &
