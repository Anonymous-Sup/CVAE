...
# # ===========Stage 1 traning================
nohup python -u main.py --cfg ./configs/tuberlin_categray/clipreid_cvae_kl.yaml \
...
--gpu 1 \
--saved_name baseTuberlin_SimpleVAE_128+64z_1e3_60+120_KLtotalZ_noCLS \
--vae_type SinpleVAE \
--recon_loss mse \
--reid_loss crossentropy \
--gaussian MultivariateNormal \
> nohup_logs/train_baseTuberlin_SimpleVAE_128+64z_1e3_60+120_KLtotalZ_noCLS.log 2>&1 &
...
--train_stage klNocls_stage \
--gpu 1 \
--saved_name baseTuberlin_SimpleVAE+2E_128+64z_1e3_60+120_KLtotalZ_noCLS \
--vae_type SinpleVAE \
--recon_loss mse \
--use_two_encoder \
--reid_loss crossentropy \
--gaussian MultivariateNormal \
> nohup_logs/train_baseTuberlin_SimpleVAE+2E_128+64z_1e3_60+120_KLtotalZ_noCLS.log 2>&1 &

# CUDA_VISIBLE_DEVICES=2
# # ===========Base ReID+CLS Stage traning================
# nohup python -u main.py --cfg ./configs/sketchy_categray/clipreid_cvae_kl.yaml \
# --root /home/zhengwei/my_data/datasets \
# --output /data/zhengwei/CVAE/outputs \
# --dataset sketchy \
# --format_tag tensor \
...
# --resume /data/zhengwei/CVAE/outputs/sketchy/clipreid_simplevae_base/2024-09-17/baseSketchy_SimpleVAE_128+64z_1e3_60+120_KLtotalZ_noCLS \
# --gpu 2 \
# --saved_name baseSketchy_SimpleVAE_128+64z_1e3_60+120_KLtotalZ_L1280+bnTuneVersion+CLS_Trip+Center+Ce \
# --vae_type SinpleVAE \
# --recon_loss mse \
# --reid_loss crossentropy \
# --gaussian MultivariateNormal \
# > nohup_logs/train_2nd_baseSketchy_SimpleVAE_128+64z_1e3_60+120_KLtotalZ_L1280+bnTuneVersion+CLS_Trip+Center+Ce.log 2>&1 &
...
# --train_format base \
# --train_stage reid+cls_stage \
# --resume /data/zhengwei/CVAE/outputs/sketchy/clipreid_simplevae_base/2024-09-17/baseSketchy_SimpleVAE+2E_128+64z_1e3_60+120_KLtotalZ_noCLS \
# --gpu 2 \
# --saved_name baseSketchy_SimpleVAE+2E_128+64z_1e3_60+120_KLtotalZ_L1280+bnTuneVersion+CLS_Trip+Center+Ce \
# --vae_type SinpleVAE \
# --recon_loss mse \
# --use_two_encoder \
# --reid_loss crossentropy \
# --gaussian MultivariateNormal \
# > nohup_logs/train_2nd_baseSketchy_SimpleVAE+2E_128+64z_1e3_60+120_KLtotalZ_L1280+bnTuneVersion+CLS_Trip+Center+Ce.log 2>&1 &
