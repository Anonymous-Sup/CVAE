...
# --gpu 2 \
# --saved_name novelSketchy_SimpleVAE_128+64z_1e3_60+120_KLtotalZ_all5w5s_noCLS_forLinear \
# --vae_type SinpleVAE \
# --recon_loss mse \
# --reid_loss crossentropy \
# --gaussian MultivariateNormal \
# > nohup_logs/tune_novelSketchy_SimpleVAE_128+64z_1e3_60+120_KLtotalZ_all5w5s_noCLS_forLinear.log 2>&1 &
...
# --train_stage klNocls_stage \
# --gpu 2 \
# --saved_name novelSketchy_SimpleVAE+2E_128+64z_1e3_60+120_KLtotalZ_all5w5s_noCLS_forLinear \
# --vae_type SinpleVAE \
# --recon_loss mse \
# --use_two_encoder \
# --reid_loss crossentropy \
# --gaussian MultivariateNormal \
# > nohup_logs/tune_novelSketchy_SimpleVAE+2E_128+64z_1e3_60+120_KLtotalZ_all5w5s_noCLS_forLinear.log 2>&1 &
...
--gpu 1 \
--saved_name novelSketchy_SimpleVAE_128+64z_1e4_60+120_KLtotalZ_all5w1s_L1280+bnTuneVersion+CLS_Trip+Center+Ce \
--vae_type SinpleVAE \
--recon_loss mse \
--reid_loss crossentropy \
--gaussian MultivariateNormal \
> nohup_logs/tune_2nd_novelSketchy_SimpleVAE_128+64z_1e4_60+120_KLtotalZ_all5w1s_L1280+bnTuneVersion+CLS_Trip+Center+Ce.log 2>&1 &
...
--gpu 1 \
--saved_name novelSketchy_SimpleVAE+2E_128+64z_1e4_60+120_KLtotalZ_all5w1s_L1280+bnTuneVersion+CLS_Trip+Center+Ce \
--vae_type SinpleVAE \
--recon_loss mse \
--use_two_encoder \
--reid_loss crossentropy \
--gaussian MultivariateNormal \
> nohup_logs/tune_2nd_novelSketchy_SimpleVAE+2E_128+64z_1e4_60+120_KLtotalZ_all5w1s_L1280+bnTuneVersion+CLS_Trip+Center+Ce.log 2>&1 &
