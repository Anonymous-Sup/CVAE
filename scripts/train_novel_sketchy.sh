...
--gpu 3 \
--saved_name novelSketchy_SimpleVAE_128+64z_1e3_60+120_KLtotalZ+lessC_all5w1s_noCLS_forLinear_\
--vae_type SinpleVAE \
--recon_loss mse \
...
# --gpu 1 \
# --saved_name novelSketchy_SimpleVAE_128+64z_1e4_60+120_KLtotalZ_all5w5s_L1280+bnTuneVersion+distCLS_Trip+Center+Ce \
# --vae_type SinpleVAE \
# --recon_loss mse \
# --reid_loss crossentropy \
# --gaussian MultivariateNormal \
# > nohup_logs/tune_2nd_novelSketchy_SimpleVAE_128+64z_1e4_60+120_KLtotalZ_all5w5s_L1280+bnTuneVersion+distCLS_Trip+Center+Ce.log 2>&1 &
...
# --gpu 1 \
# --saved_name novelSketchy_SimpleVAE+2E_128+64z_1e4_60+120_KLtotalZ_all5w5s_L1280+bnTuneVersion+distCLS_Trip+Center+Ce \
# --vae_type SinpleVAE \
# --recon_loss mse \
# --use_two_encoder \
# --reid_loss crossentropy \
# --gaussian MultivariateNormal \
# > nohup_logs/tune_2nd_novelSketchy_SimpleVAE+2E_128+64z_1e4_60+120_KLtotalZ_all5w5s_L1280+bnTuneVersion+distCLS_Trip+Center+Ce.log 2>&1 &
