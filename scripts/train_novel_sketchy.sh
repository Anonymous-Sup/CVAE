...
# --gpu 2 \
# --saved_name ablation_withouU_novelSketchy_SimpleVAE_128+64z_1e3_30+60_KLtotalZ+lessC_all5w5s_noCLS_forLinear \
# --vae_type SinpleVAE \
# --recon_loss mse \
# --reid_loss crossentropy \
# --gaussian MultivariateNormal \
# > nohup_logs/ablation_withouU_tune_novelSketchy_SimpleVAE_128+64z_1e3_30+60_KLtotalZ+lessC_all5w5s_noCLS_forLinear.log 2>&1 &
...
# --train_stage klNocls_stage \
# --gpu 2 \
# --saved_name ablation_withouU_novelSketchy_SimpleVAE+2E_128+64z_1e3_30+60_KLtotalZ+lessC_all5w5s_noCLS_forLinear \
# --vae_type SinpleVAE \
# --recon_loss mse \
# --use_two_encoder \
# --reid_loss crossentropy \
