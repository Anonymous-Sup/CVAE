...
--gpu 1 \
--saved_name novelMask1KFew_SimpleVAE_128+64z_1e3_30+60_KLtotalZ+lessC_all5w1s_noCLS_forLinear \
--vae_type SinpleVAE \
--recon_loss mse \
--reid_loss crossentropy \
--gaussian MultivariateNormal \
> nohup_logs/tune_novelMask1KFew_SimpleVAE_128+64z_1e3_30+60_KLtotalZ+lessC_all5w1s_noCLS_forLinear.log 2>&1 &
...
--train_stage klNocls_stage \
--gpu 1 \
--saved_name novelMask1KFew_SimpleVAE+2E_128+64z_1e3_30+60_KLtotalZ+lessC_all5w1s_noCLS_forLinear \
--vae_type SinpleVAE \
--recon_loss mse \
--use_two_encoder \
--reid_loss crossentropy \
--gaussian MultivariateNormal \
> nohup_logs/tune_novelMask1KFew_SimpleVAE+2E_128+64z_1e3_30+60_KLtotalZ+lessC_all5w1s_noCLS_forLinear.log 2>&1 &
...
# --resume  xxxxx \
# --gpu 2 \
# --saved_name novelMask1KFew_SimpleVAE_128+64z_1e3_30+50+120_KLtotalZ+lessC_L1280+bnTuneVersion+CLS_Trip+Center+Ce \
# --vae_type SinpleVAE \
# --recon_loss mse \
# --reid_loss crossentropy \
# --gaussian MultivariateNormal \
# > nohup_logs/tune_2nd_novelMask1KFew_SimpleVAE_128+64z_1e3_30+50+120_KLtotalZ+lessC_L1280+bnTuneVersion+CLS_Trip+Center+Ce.log 2>&1 &
...
# --resume  xxx \
# --gpu 2 \
# --saved_name novelMask1KFew_SimpleVAE+2E_128+64z_1e3_30+50+120_KLtotalZ+lessC_L1280+bnTuneVersion+CLS_Trip+Center+Ce \
# --vae_type SinpleVAE \
# --recon_loss mse \
# --use_two_encoder \
# --reid_loss crossentropy \
# --gaussian MultivariateNormal \
# > nohup_logs/tune_2nd_novelMask1KFew_SimpleVAE+2E_128+64z_1e3_30+50+120_KLtotalZ+lessC_L1280+bnTuneVersion+CLS_Trip+Center+Ce.log 2>&1 &
