...
--reid_loss crossentropy \
--gaussian MultivariateNormal \
> nohup_logs/train_2nd_baseCelebHQ_SimpleVAE_128+64z_1e3_60+120_KLtotalZ_L1280+bnTuneVersion+CLS_Trip+Center+Ce.log 2>&1 &
...
--reid_loss crossentropy \
--gaussian MultivariateNormal \
> nohup_logs/train_2nd_baseCelebHQ_SimpleVAE+2E_128+64z_1e3_60+120_KLtotalZ_L1280+bnTuneVersion+CLS_Trip+Center+Ce.log 2>&1 &
