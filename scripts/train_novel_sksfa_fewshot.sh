...
# --gpu 3 \
# --saved_name novelSKSFFew_SimpleVAE_128+64z_1e3_30+50+120_KLtotalZ+lessC_L1280+bnTuneVersion+CLS_all5w2s_3times_Trip+Center+Ce \
# --vae_type SinpleVAE \
# --recon_loss mse \
# --reid_loss crossentropy \
# --gaussian MultivariateNormal \
# > nohup_logs/tune_2nd_novelSKSFFew_SimpleVAE_128+64z_1e3_30+50+120_KLtotalZ+lessC_L1280+bnTuneVersion+CLS_all5w2s_3times_Trip+Center+Ce.log 2>&1 &
...
# --gpu 3 \
# --saved_name novelSKSFFew_SimpleVAE+2E_128+64z_1e3_30+50+120_KLtotalZ+lessC_L1280+bnTuneVersion+CLS_all5w2s_3times_Trip+Center+Ce \
# --vae_type SinpleVAE \
# --recon_loss mse \
# --use_two_encoder \
# --reid_loss crossentropy \
# --gaussian MultivariateNormal \
# > nohup_logs/tune_2nd_novelSKSFFew_SimpleVAE+2E_128+64z_1e3_30+50+120_KLtotalZ+lessC_L1280+bnTuneVersion+CLS_all5w2s_3times_Trip+Center+Ce.log 2>&1 &
