...
--resume /data/zhengwei/CVAE/outputs/tuberlin/clipreid_simplevae_base/novel/2024-09-19/novelTUBerlin_SimpleVAE_128+64z_1e3_60+120_KLtotalZ+lessC_true5w1s_noCLS_forLinear \
--gpu 1 \
--saved_name novelTUBerlin_SimpleVAE_128+64z_1e4_60+120_KLtotalZ+lessC_true5w1s_L1280+bnTuneVersion+CLS_Trip+Center+Ce \
--vae_type SinpleVAE \
--recon_loss mse \
--reid_loss crossentropy \
--gaussian MultivariateNormal \
> nohup_logs/tune_2nd_novelTUBerlin_SimpleVAE_128+64z_1e4_60+120_KLtotalZ+lessC_true5w1s_L1280+bnTuneVersion+CLS_Trip+Center+Ce.log 2>&1 &
...
--train_format novel \
--train_stage reid+cls_stage \
--resume  /data/zhengwei/CVAE/outputs/tuberlin/clipreid_simplevae_base/novel/2024-09-19/novelTUBerlin_SimpleVAE+2E_128+64z_1e3_60+120_KLtotalZ+lessC_true5w1s_noCLS_forLinear \
--gpu 1 \
--saved_name novelTUBerlin_SimpleVAE+2E_128+64z_1e4_60+120_KLtotalZ+lessC_true5w1s_L1280+bnTuneVersion+CLS_Trip+Center+Ce \
--vae_type SinpleVAE \
--recon_loss mse \
--use_two_encoder \
--reid_loss crossentropy \
--gaussian MultivariateNormal \
> nohup_logs/tune_2nd_novelTUBerlin_SimpleVAE+2E_128+64z_1e4_60+120_KLtotalZ+lessC_true5w1s_L1280+bnTuneVersion+CLS_Trip+Center+Ce.log 2>&1 &
