...
--gpu 1 \
--saved_name novelTUBerlin_SimpleVAE_128+64z_1e3_60_KLtotalZ+lessC_all5w5s_L1280+bnTuneVersion+CLS_Tripwrt+Center+Ce \
--vae_type SinpleVAE \
--recon_loss mse \
--reid_loss crossentropy \
--gaussian MultivariateNormal \
> nohup_logs/tune_2nd_novelTUBerlin_SimpleVAE_128+64z_1e3_60_KLtotalZ+lessC_all5w5s_L1280+bnTuneVersion+CLS_Tripwrt+Center+Ce.log 2>&1 &
...
--gpu 1 \
--saved_name novelTUBerlin_SimpleVAE+2E_128+64z_1e3_60_KLtotalZ+lessC_all5w5s_L1280+bnTuneVersion+CLS_Tripwrt+Center+Ce \
--vae_type SinpleVAE \
--recon_loss mse \
--use_two_encoder \
--reid_loss crossentropy \
--gaussian MultivariateNormal \
> nohup_logs/tune_2nd_novelTUBerlin_SimpleVAE+2E_128+64z_1e3_60_KLtotalZ+lessC_all5w5s_L1280+bnTuneVersion+CLS_Tripwrt+Center+Ce.log 2>&1 &
