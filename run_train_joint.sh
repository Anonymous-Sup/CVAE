...
# --format_tag tensor \
# --train_format base \
# --train_stage kl_cls_stage \
# --gpu 0 \
# --saved_name SimpleVAE_128+64z_1e3_60+120_KLtotalZ_CLS \
# --vae_type SinpleVAE \
# --recon_loss mse \
# --reid_loss crossentropy \
# --gaussian MultivariateNormal \
# > train_base_clipreid_SimpleVAE_128+64z_1e3_60+120_KLtotalZ_CLS.log 2>&1 &
...
# --format_tag tensor \
# --train_format base \
# --train_stage kl_reid_stage \
# --gpu 0 \
# --saved_name SimpleVAE_128+64z_1e3_60+120_KLtotalZ_ReIDcenter+trip \
# --vae_type SinpleVAE \
# --recon_loss mse \
# --reid_loss crossentropy \
# --gaussian MultivariateNormal \
# > train_base_clipreid_SimpleVAE_128+64z_1e3_60+120_KLtotalZ_ReIDcenter+trip.log 2>&1 &
...
# --train_stage klstage \
# --gpu 0 \
# --saved_name SimpleVAE_128+64z_1e3_60+120_KLtotalZ_CLS_ReID+circle \
# --vae_type SinpleVAE \
# --recon_loss mse \
# --reid_loss crossentropy \
# --gaussian MultivariateNormal \
# > train_base_clipreid_SimpleVAE_128+64z_1e3_60+120_KLtotalZ_CLS_ReID+circle.log 2>&1 &
...
# --resume /home/zhengwei/Desktop/Zhengwei/Projects/CVAE/outputs/duke/clipreid_simplevae_base/2024-07-31/SimpleVAE+2E_128+64z_1e3_60+120_KLtotalZ_CLS \
# --gpu 0 \
# --saved_name 2nd_SimpleVAE+2E_128+64z_warm5+1e3+d1e4_60+120_KLtotalZ+CLS_L1280_ReIDZnew+circle \
# --vae_type SinpleVAE \
# --recon_loss mse \
# --use_two_encoder \
# --reid_loss crossentropy \
# --gaussian MultivariateNormal \
# > 2nd_train_base_clipreid_SimpleVAE+2E_128+64z_warm5+1e3+d1e4_60+120_KLtotalZ+CLS_L1280_ReIDZnew+circle.log 2>&1 & 
...
# --train_format base \
# --train_stage reidstage \
# --resume /home/zhengwei/Desktop/Zhengwei/Projects/CVAE/outputs/duke/clipreid_simplevae_base/2024-07-31/SimpleVAE_128+64z_1e3_60+120_KLtotalZ_CLS \
# --gpu 0 \
# --saved_name 2nd_SimpleVAE_128+64z_warm5+1e3+d1e4_60+120_KLtotalZ+CLS_L1280_ReIDZnew+circle \
# --vae_type SinpleVAE \
# --recon_loss mse \
# --reid_loss crossentropy \
# --gaussian MultivariateNormal \
# > 2nd_train_base_clipreid_SimpleVAE_128+64z_warm5+1e3+d1e4_60+120_KLtotalZ+CLS_L1280_ReIDZnew+circle.log 2>&1 & 
...
# --train_format novel \
# --train_stage kl_cls_stage \
# --resume /home/zhengwei/Desktop/Zhengwei/Projects/CVAE/outputs/duke/clipreid_simplevae_base/2024-07-31/SimpleVAE_128+64z_1e3_60+120_KLtotalZ_CLS/2nd_stage/2024-07-31/2nd_SimpleVAE_128+64z_warm5+1e3+d1e4_60+120_KLtotalZ+CLS_L1280_ReIDZnew+circle \
# --gpu 0 \
# --saved_name tune_SimpleVAE_128+64z_1e3_60+120_KLtotalZ+CLS_L1280_ReIDZnew \
# --vae_type SinpleVAE \
# --recon_loss mse \
# --reid_loss crossentropy \
# --gaussian MultivariateNormal \
# > tune_Sketch_SimpleVAE_128+64z_1e3_60+120_KLtotalZ+CLS_L1280_ReIDZnew.log 2>&1 & 
...
# --train_format novel \
# --train_stage kl_cls_stage \
# --resume /home/zhengwei/Desktop/Zhengwei/Projects/CVAE/outputs/duke/clipreid_simplevae_base/2024-07-31/SimpleVAE+2E_128+64z_1e3_60+120_KLtotalZ_CLS/2nd_stage/2024-07-31/2nd_SimpleVAE+2E_128+64z_warm5+1e3+d1e4_60+120_KLtotalZ+CLS_L1280_ReIDZnew+circle \
# --gpu 0 \
# --saved_name tune_SimpleVAE+2E_128+64z_1e3_60+120_KLtotalZ+CLS_L1280_ReIDZnew_encoderScratch \
# --vae_type SinpleVAE \
# --recon_loss mse \
# --use_two_encoder \
# --reid_loss crossentropy \
# --gaussian MultivariateNormal \
# > tune_Sketch_SimpleVAE+2E_128+64z_1e3_60+120_KLtotalZ+CLS_L1280_ReIDZnew_encoderScratch.log 2>&1 & 
...
# --format_tag tensor \
# --train_format novel \
# --resume /home/zhengwei/Desktop/Zhengwei/Projects/CVAE/outputs/market1k/clipreid_tune_wReID/novel/2024-08-01/tune_SimpleVAE_128+64z_1e3_60+120_KLtotalZ+CLS_L1280_ReIDZnew \
# --train_stage reidstage \
# --gpu 0 \
# --saved_name sketch_2ndstage_SimpleVAE_128+64z_1e3_60+120_KLtotalZ+CLS_L1280_ReIDZnew+circle \
# --vae_type SinpleVAE \
# --recon_loss mse \
# --reid_loss crossentropy \
# --gaussian MultivariateNormal \
# > sketch_2ndstage_SimpleVAE_128+64z_1e3_60+120_KLtotalZ+CLS_L1280_ReIDZnew+circle.log 2>&1 & 
...
--format_tag tensor \
--train_format novel \
--resume /home/zhengwei/Desktop/Zhengwei/Projects/CVAE/outputs/market1k/clipreid_tune_wReID/novel/2024-08-01/tune_SimpleVAE+2E_128+64z_1e3_60+120_KLtotalZ+CLS_L1280_ReIDZnew_encoderScratch \
--train_stage reidstage \
--gpu 0 \
--saved_name sketch_2ndstage_SimpleVAE+2E_128+64z_1e3_60+120_KLtotalZ+CLS_encoderScratch_L1280_ReIDZnew_circle \
--vae_type SinpleVAE \
--recon_loss mse \
--use_two_encoder \
--reid_loss crossentropy \
--gaussian MultivariateNormal \
> sketch_2ndstage_SimpleVAE+2E_128+64z_1e3_60+120_KLtotalZ+CLS_encoderScratch_L1280_ReIDZnew_circle.log 2>&1 & 
