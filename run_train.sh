...
--train_stage klstage \
--gpu 0 \
--saved_name fp32_l4vae+LeakRelu+bn_64z_klJ_noU_z0 \
--vae_type cvae \
--flow_type yuke_mlpflow \
--recon_loss mse \
...
--only_x_input \
--gaussian MultivariateNormal \
> train_clipreid_klJ_noU_z0.log 2>&1 & 
...
# --format_tag tensor \
# --train_format novel \
# --resume /home/zhengwei/Desktop/Zhengwei/Projects/CVAE/outputs/duke/clipreid_cvae/2024-04-13/fp32_l4vaeleakRelu-lre4_MG+yukeflow_64z_klnoJ_UindexC_yuke_mlpflow_mse \
# --train_stage klstage \
# --gpu 0 \
# --saved_name fp32_l4vaeleakRelu-lre4_MG+yukeflow_64z_klnoJ_UindexC_aLoss \
# --vae_type cvae \
# --flow_type yuke_mlpflow \
# --recon_loss mse \
# --reid_loss crossentropylabelsmooth \
...
# --only_cvae_kl \
# --gaussian MultivariateNormal \
# > train_novel_ClIPReID_Uc_klnoJ_aLoss.log 2>&1 & 
