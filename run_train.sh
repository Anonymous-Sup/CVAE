...
# --train_stage klstage \
# --gpu 0 \
# --saved_name fp32_l4vae+LeakRelu+bn_64z_SingleAdapterU_normUZ_bpfusion_Lrecon+trip+reid_1e3 \
# --vae_type cvae \
# --recon_loss mse \
# --reid_loss crossentropylabelsmooth \
# --use_centroid \
# > train_clipreid_bn_64z_SingleAdapterU_normUZ_bpfusion_Lrecon+trip+reid_1e3.log 2>&1 & 
...
--format_tag tensor \
--train_format novel \
--resume /home/zhengwei/Desktop/Zhengwei/Projects/CVAE/outputs/duke/clipreid_cvae_decouple/2024-05-10/fp32_l4vae+LeakRelu+bn_64z_SingleAdapterU_normUZ_bpfusion_Lrecon_1e3 \
--train_stage klstage \
--gpu 0 \
--saved_name fp32_l4vae+LeakRelu+bn_64z_SingleAdapterU_normUZ_bpfusion_LreconA_1e4 \
--vae_type cvae \
--recon_loss mse \
--reid_loss crossentropylabelsmooth \
--use_centroid \
> finetune_novel_ClIPReID_bn_64z_SingleAdapterU_normUZ_bpfusion_LreconA_1e4.log 2>&1 & 
