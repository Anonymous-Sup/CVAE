...
--train_stage klstage \
--gpu 0 \
--saved_name fp32_l4vae+LeakRelu+bn_64z_klJ_noU_normZ_partialBN+fuseZ \
--vae_type cvae \
--flow_type yuke_mlpflow \
--recon_loss mse \
...
--only_x_input \
--gaussian MultivariateNormal \
> train_clipreid_klJ_noU_nromZ_partialBN_fuseZ.log 2>&1 & 
...
# --format_tag tensor \
# --train_format novel \
# --resume /home/zhengwei/Desktop/Zhengwei/Projects/CVAE/outputs/duke/clipreid_cvae/2024-04-23/fp32_l4vae+LeakRelu+bn_64z_klnoJ_noU_yuke_mlpflow_mse \
# --train_stage klstage \
# --gpu 0 \
# --saved_name fp32_l4vae+LeakRelu+bn_64z_klnoJ_noU  \
# --vae_type cvae \
# --flow_type yuke_mlpflow \
# --recon_loss mse \
# --reid_loss crossentropylabelsmooth \
...
# --only_x_input \
# --gaussian MultivariateNormal \
# > finetune_novel_ClIPReID_aLoss_klnoJ_bn.log 2>&1 & 
