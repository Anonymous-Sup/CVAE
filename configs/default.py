...
_C.TRAIN.OPTIMIZER.SGDLR = 1e-2
_C.TRAIN.OPTIMIZER.SGD_MOMENTUM = 0.9
_C.TRAIN.OPTIMIZER.SGD_WEIGHT_DECAY = 5e-4
...
def update_config(config, args):
    ...
    elif 'kl' not in args.train_stage:
        config.OUTPUT = os.path.join(config.MODEL.RESUME, '2nd_stage', datetime_today, config.SAVED_NAME)
    else:
